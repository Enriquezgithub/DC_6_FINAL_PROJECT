...
<template>
    <main>
        <Head title="Login"/>
        <div class="background-image flex items-center relative">
            <div class="w-full">
                <div class="border absolute border-gray-400 bg-white w-[30%] p-4 min-h-[45vh] rounded top-24 left-28 shadow">
                ...
                <div v-if="errors.email || errors.password" class="p-3 text-md text-red-800 rounded border-red-700 bg-red-300" role="alert">
                    ...
                    <h1 class="text-center mb-2">Admin can be found in DatabaseSeeder.</h1>
