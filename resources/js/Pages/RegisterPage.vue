            ...
            <div class="border border-gray-400 w-[30%] p-4 min-h-[45vh] rounded mx-auto mt-40">
                ...
                <form @submit.prevent="form.post(route('register.post'))">
                    <div class="mt-3">
                       ...
                       <input type="text"  class="w-full rounded" v-model="form.username"> 
                       <div class="text-red-700" v-if="errors.username">{{ errors.username }}</div>
                    </div>  
                    <div class="mt-3">
                       <label for="">Email</label>
                       <input type="email"  class="w-full rounded" v-model="form.email">
                    ...
                    <div class="text-center mt-10">
                       <button type="submit" class="bg-blue-600 px-44 py-3 text-xl text-white tracking-wider text-bold rounded">Register</button>
                    </div>
                </form>
            </div>
        </div>
